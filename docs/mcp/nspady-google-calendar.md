...
1. Add this configuration to your Claude Desktop config file. E.g. `/Users//Library/Application Support/Claude/claude_desktop_config.json`:
```json
   {
     "mcpServers": {
       "google-calendar": {
...
**Official site: ** [https://github.com/nspady/google-calendar-mcp](https://github.com/nspady/google-calendar-mcp)
...
Resource file: `resources/mcp/nspady-google-calendar.json`. Content last verified on `2026-08-30`; free quotas and service limits may change with official policies.
