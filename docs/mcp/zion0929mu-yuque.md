---
title: "语雀"
description: "本项目基于FastMCP框架，提供一个专门用于管理语雀知识库的MCP服务器。该服务器支持自动识别并创建知识库分组、创建或更新文档、获取文档详情、文档列表及完整知识库目录，并支持分页查询与结构化数据返回。所有操作均基于语雀官方API实现。"
---

# 语雀

本项目基于FastMCP框架，提供一个专门用于管理语雀知识库的MCP服务器。该服务器支持自动识别并创建知识库分组、创建或更新文档、获取文档详情、文档列表及完整知识库目录，并支持分页查询与结构化数据返回。所有操作均基于语雀官方API实现。
...
**官方网站：** [https://github.com/lijian-ui/yuque-mcp](https://github.com/lijian-ui/yuque-mcp)
...
资源文件：`resources/mcp/zion0929mu-yuque.json`。内容最后核验于 `2026-08-30`；免费额度和服务限制可能随官方政策变化。
