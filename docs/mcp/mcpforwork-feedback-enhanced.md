...
- **Detailed Documentation**: [SSH Remote Environment Usage Guide](https://github.com/Minidoracat/mcp-feedback-enhanced/blob/HEAD/docs/en/ssh-remote/browser-launch-issues.md)
...
### Qt GUI Interface (Refactored Version)
   ...
   width="400" alt="Qt GUI Main Interface" />
   width="400" alt="Qt GUI Settings Interface" />

*Qt GUI Interface - Modular refactoring, supporting local environments*

### Web UI Interface (Refactored Version)

   width="400" alt="Web UI Main Interface" />
   width="400" alt="Web UI Settings Interface" />
...
📋 **Complete Version History:** [RELEASE_NOTES/CHANGELOG.en.md](https://github.com/Minidoracat/mcp-feedback-enhanced/blob/HEAD/RELEASE_NOTES/CHANGELOG.en.md)
...
A: This is normal behavior. SSH Remote environments have no graphical interface, requiring manual opening in local browser. For detailed solutions, see: [SSH Remote Environment Usage Guide](https://github.com/Minidoracat/mcp-feedback-enhanced/blob/HEAD/docs/en/ssh-remote/browser-launch-issues.md)
...
uv cache clean
```
For detailed instructions, see: [Cache Management Guide](https://github.com/Minidoracat/mcp-feedback-enhanced/blob/HEAD/docs/en/cache-management.md)
...
MIT License - see [LICENSE](https://github.com/Minidoracat/mcp-feedback-enhanced/blob/HEAD/LICENSE) file for details
