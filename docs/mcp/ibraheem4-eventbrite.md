...
This is a Model Context Protocol (MCP) server that provides tools for interacting with the Eventbrite API. It allows AI assistants to search for events, get event details, retrieve venue information, and more.
   ...
   alt="Eventbrite Server MCP server" />
...
**Official site: ** [https://github.com/ibraheem4/eventbrite-mcp](https://github.com/ibraheem4/eventbrite-mcp)
**Status: ** `active`　**Last verified: ** `2026-08-30`

## Categories & Tags

- Categories: `media`
- Tags: `entertainment and media`, `social media`, `search`, `chinese`
...
Resource file: `resources/mcp/ibraheem4-eventbrite.json`. Content last verified on `2026-08-30`; free quotas and service limits may change with official policies.
