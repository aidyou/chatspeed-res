...
**Official site: ** [https://github.com/letsbuildagent/perplexity-tool](https://github.com/letsbuildagent/perplexity-tool)
...
Resource file: `resources/mcp/letsbuildagent-perplexity-tool.json`. Content last verified on `2026-08-30`; free quotas and service limits may change with official policies.
