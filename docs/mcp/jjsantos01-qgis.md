...
1. **[QGIS plugin](https://github.com/jjsantos01/qgis_mcp/tree/HEAD/qgis_mcp_plugin)**: A QGIS plugin that creates a socket server within QGIS to receive and execute commands.
2. **[MCP Server](https://github.com/jjsantos01/qgis_mcp/blob/HEAD/src/qgis_mcp/qgis_mcp_server.py)**: A Python server that implements the Model Context Protocol and connects to the QGIS plugin.
...
You need to copy the folder [qgis_mcp_plugin](https://github.com/jjsantos01/qgis_mcp/tree/HEAD/qgis_mcp_plugin) and its content on your QGIS profile plugins folder.
...
> On a Windows machine the plugins folder is usually located at:
    `C:UsersUSERAppDataRoamingQGISQGIS3profilesdefaultpythonplugins` and on MacOS:
...
**Official site: ** [https://github.com/jjsantos01/qgis_mcp](https://github.com/jjsantos01/qgis_mcp)
...
Resource file: `resources/mcp/jjsantos01-qgis.json`. Content last verified on `2026-08-30`; free quotas and service limits may change with official policies.
