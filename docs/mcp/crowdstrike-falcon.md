...
- [Google Cloud (Agent Platform / Gemini Enterprise)](https://github.com/CrowdStrike/falcon-mcp/blob/HEAD/examples/adk/README.md)
...
> [!IMPORTANT]
> This project uses [Conventional Commits](https://www.conventionalcommits.org/) for automated releases. Please follow the commit message format outlined in our [Contributing Guide](https://github.com/CrowdStrike/falcon-mcp/blob/HEAD/.github/CONTRIBUTING.md).

### Developer Documentation

- [Documentation Guide](https://github.com/CrowdStrike/falcon-mcp/blob/HEAD/docs/development/docs-site.md): Architecture and maintenance guide for the documentation
- [Module Development Guide](https://github.com/CrowdStrike/falcon-mcp/blob/HEAD/docs/development/module-development.md): Instructions for implementing new modules
- [Resource Development Guide](https://github.com/CrowdStrike/falcon-mcp/blob/HEAD/docs/development/resource-development.md): Instructions for implementing resources
- [Integration Testing Guide](https://github.com/CrowdStrike/falcon-mcp/blob/HEAD/docs/development/integration-testing.md): Guide for running integration tests with real API calls
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/CrowdStrike/falcon-mcp/blob/HEAD/LICENSE) file for details.
