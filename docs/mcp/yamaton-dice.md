...
![screenshot](/mcp-assets/1b3508a9a643e1818fcec12c9672299d.png)
...
**Official site: ** [https://github.com/yamaton/mcp-dice](https://github.com/yamaton/mcp-dice)
...
- Transport: `stdio`
- Command: `wsl`
- Args: `-e zsh -lc uvx mcp-dice`

This config can be imported into ChatSpeed from the resource index. Verify the command, arguments, and permission source are trustworthy before importing.

## Data source

Resource file: `resources/mcp/yamaton-dice.json`. Content last verified on `2026-08-30`; free quotas and service limits may change with official policies.
