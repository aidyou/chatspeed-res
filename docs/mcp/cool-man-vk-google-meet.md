...
description: "The Google Meet MCP Server enables AI agents to create, manage, and retrieve Google Meet meetings. Built on the Model Context Protocol, it exposes tools for scheduling, updating, and deleting meetings…"
---

# google-meet-mcp-server

The Google Meet MCP Server enables AI agents to create, manage, and retrieve Google Meet meetings. Built on the Model Context Protocol, it exposes tools for scheduling, updating, and deleting meetings…
...
**Official site: ** [https://github.com/cool-man-vk/google-meet-mcp-server](https://github.com/cool-man-vk/google-meet-mcp-server)
...
Resource file: `resources/mcp/cool-man-vk-google-meet.json`. Content last verified on `2026-08-30`; free quotas and service limits may change with official policies.
