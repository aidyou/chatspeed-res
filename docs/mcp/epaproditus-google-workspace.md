...
**Official site: ** [https://github.com/epaproditus/google-workspace-mcp-server](https://github.com/epaproditus/google-workspace-mcp-server)
...
Resource file: `resources/mcp/epaproditus-google-workspace.json`. Content last verified on `2026-08-30`; free quotas and service limits may change with official policies.
