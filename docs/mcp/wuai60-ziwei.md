---
title: "ziwei-mcp"
description: "Zi Wei Dou Shu MCP Server A professional Zi Wei Dou Shu (Purple Star Astrology) fortune-telling analysis server based on the Model Context Protocol (MCP), providing complete chart generation, interpre…"
---

# ziwei-mcp

Zi Wei Dou Shu MCP Server A professional Zi Wei Dou Shu (Purple Star Astrology) fortune-telling analysis server based on the Model Context Protocol (MCP), providing complete chart generation, interpre…
...
- **SQLite deployment**: [SQLite deployment guide](https://github.com/SiwuXue/ziwei-mcp/blob/HEAD/SQLite部署指南.md)
- **SVG generation**: [SVG generator usage guide](https://github.com/SiwuXue/ziwei-mcp/blob/HEAD/SVG生成器使用指南.md)
