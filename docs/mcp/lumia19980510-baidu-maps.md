...
如果你希望自定义百度地图MCP Server的能力，可以通过[源码](https://github.com/baidu-maps/mcp/blob/HEAD/src/baidu-map/python/src/mcp_server_baidu_maps/map.py)接入，方式详见[Python接入文档](https://github.com/baidu-maps/mcp/blob/HEAD/src/baidu-map/python/README.md)。
...
[MIT](https://github.com/baidu-maps/mcp/blob/HEAD/LICENSE) © baidu-maps
