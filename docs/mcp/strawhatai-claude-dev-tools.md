...
### Edit Tools
- `edit_block`: Apply surgical text replacements (best for changes 20% or when edit_block fails)
...
**Official site: ** [https://github.com/strawhatai/claude-dev-tools](https://github.com/strawhatai/claude-dev-tools)
...
Resource file: `resources/mcp/strawhatai-claude-dev-tools.json`. Content last verified on `2026-08-30`; free quotas and service limits may change with official policies.
