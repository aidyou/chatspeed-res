...
**Official site: ** [https://github.com/Legaltime/filesystem](https://github.com/Legaltime/filesystem)
...
Resource file: `resources/mcp/legaltime-filesystem.json`. Content last verified on `2026-08-30`; free quotas and service limits may change with official policies.
