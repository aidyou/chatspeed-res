...
- `autoApprove`: List of tools that Do not require explicit approval for each use
...
**Official site: ** [https://github.com/marcopesani/mcp-server-serper](https://github.com/marcopesani/mcp-server-serper)
...
Resource file: `resources/mcp/marcopesani-serper.json`. Content last verified on `2026-08-30`; free quotas and service limits may change with official policies.
