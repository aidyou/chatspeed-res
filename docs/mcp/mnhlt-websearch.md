...
**Official site: ** [https://github.com/mnhlt/WebSearch-MCP](https://github.com/mnhlt/WebSearch-MCP)
...
Resource file: `resources/mcp/mnhlt-websearch.json`. Content last verified on `2026-08-30`; free quotas and service limits may change with official policies.
