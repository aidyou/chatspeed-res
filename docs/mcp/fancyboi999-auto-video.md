...
description: "🛠️ 可用工具 服务器提供以下工具，可供 LLM 或其他客户端直接调用： 数字人与多媒体创作工具 - Avatar Tools (avatartools): - createpersonalavatarbyphoto: 通过单张照片创建个人数字人。 - createpersonalavatarbyvideo: 通过视频文件创建个人数字人。 - Voice Tools (voicetools): - createvoicebyfile: 通过音频文件克隆声音。 - createvoicebytext: 通过文本创建声"
---

# 自动生成口播视频（MCP&Agent挑战赛）

🛠️ 可用工具 服务器提供以下工具，可供 LLM 或其他客户端直接调用： 数字人与多媒体创作工具 - Avatar Tools (avatartools): - createpersonalavatarbyphoto: 通过单张照片创建个人数字人。 - createpersonalavatarbyvideo: 通过视频文件创建个人数字人。 - Voice Tools (voicetools): - createvoicebyfile: 通过音频文件克隆声音。 - createvoicebytext: 通过文本创建声
