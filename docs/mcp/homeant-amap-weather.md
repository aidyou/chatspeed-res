---
title: "天气查询"
description: "MCP 天气服务是一个基于高德地图 API 的天气预报服务，提供实时天气状况和天气预报数据。该服务作为 MCP (Model Control Protocol) 生态系统的一部分，可以轻松集成到支持 MCP 的应用程序中。"
---
...
[English](https://github.com/merulas/amap-mcp-weather/blob/HEAD/README_EN.md) | 中文
...
**官方网站：** [https://github.com/merulas/amap-mcp-weather](https://github.com/merulas/amap-mcp-weather)
...
- 传输方式：`stdio`
- 启动命令：`go`
- 参数：`run cmd/server/main.go`

该配置可通过资源站点索引导入 ChatSpeed。导入前请确认命令、参数和权限来源可信。

## 数据来源

资源文件：`resources/mcp/homeant-amap-weather.json`。内容最后核验于 `2026-08-30`；免费额度和服务限制可能随官方政策变化。
