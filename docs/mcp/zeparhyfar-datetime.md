...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/ZeparHyfar/mcp-datetime/blob/HEAD/LICENSE) file for details.

**Official site: ** [https://github.com/ZeparHyfar/mcp-datetime](https://github.com/ZeparHyfar/mcp-datetime)
...
Resource file: `resources/mcp/zeparhyfar-datetime.json`. Content last verified on `2026-08-30`; free quotas and service limits may change with official policies.
