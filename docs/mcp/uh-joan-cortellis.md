...
**Official site: ** [https://github.com/uh-joan/mcp-server-cortellis](https://github.com/uh-joan/mcp-server-cortellis)
...
Resource file: `resources/mcp/uh-joan-cortellis.json`. Content last verified on `2026-08-30`; free quotas and service limits may change with official policies.
