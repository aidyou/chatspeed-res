...
This project is licensed under [the MIT License](https://github.com/its-dart/dart-mcp-server/blob/HEAD/LICENSE).

**Official site: ** [https://github.com/its-dart/dart-mcp-server](https://github.com/its-dart/dart-mcp-server)
...
Resource file: `resources/mcp/its-dart-dart.json`. Content last verified on `2026-08-30`; free quotas and service limits may change with official policies.
