...
description: "@intellivng/mcp-server IntelliVNG 视觉小说游戏脚本分析 MCP Server 这是一个基于 Model Context Protocol (MCP) 的服务，提供视觉小说游戏脚本的分析工具。可被任何支持 MCP 的 AI 助手调用，用于验证和分析非线性叙事结构。 特性 - 结构校验：检测孤立节点、死胡同、无效链接，保证剧情图没有硬错误。 - 路径分析：枚举所有故事路径，评估非线性程度与多样性。 - 对话质量：分析对话分布、角色出场与情绪丰富度，辅助节奏与风格优化。 - 分支分布：检"
---

# IntelliVNG 视觉小说游戏脚本分析 MCP Server

@intellivng/mcp-server IntelliVNG 视觉小说游戏脚本分析 MCP Server 这是一个基于 Model Context Protocol (MCP) 的服务，提供视觉小说游戏脚本的分析工具。可被任何支持 MCP 的 AI 助手调用，用于验证和分析非线性叙事结构。 特性 - 结构校验：检测孤立节点、死胡同、无效链接，保证剧情图没有硬错误。 - 路径分析：枚举所有故事路径，评估非线性程度与多样性。 - 对话质量：分析对话分布、角色出场与情绪丰富度，辅助节奏与风格优化。 - 分支分布：检
