---
title: "蓝湖"
description: "一个功能强大的 Model Context Protocol (MCP) 服务器，专为 AI 编程时代设计，完美支持蓝湖（Lanhu）设计协作平台。它具有智能需求分析、团队知识共享、UI 设计支持和性能优化等功能。"
---

# 蓝湖

一个功能强大的 Model Context Protocol (MCP) 服务器，专为 AI 编程时代设计，完美支持蓝湖（Lanhu）设计协作平台。它具有智能需求分析、团队知识共享、UI 设计支持和性能优化等功能。
...
[English](https://github.com/dsphper/lanhu-mcp/blob/HEAD/README_EN.md) | 简体中文

[快速开始](#-快速开始) • [功能特性](#-核心特性) • [使用文档](#-使用指南) • [贡献指南](https://github.com/dsphper/lanhu-mcp/blob/HEAD/CONTRIBUTING.md)
...
📖 参考文档：[AI 安装指南](https://github.com/dsphper/lanhu-mcp/blob/HEAD/ai-install-guide.md) • [Cookie 获取教程](https://github.com/dsphper/lanhu-mcp/blob/HEAD/GET-COOKIE-TUTORIAL.md)
...
📖 详细文档：[Docker 部署指南](https://github.com/dsphper/lanhu-mcp/blob/HEAD/DEPLOY.md)
...
本项目采用 MIT 许可证 - 查看 [LICENSE](https://github.com/dsphper/lanhu-mcp/blob/HEAD/LICENSE) 文件了解详情。
...
[![Star History Chart](/mcp-assets/7ff5ea12648cd650854ef8cf69c6f49e.svg)](https://www.star-history.com/#dsphper/lanhu-mcp&type=date&legend=top-left)
...
- **How to integrate Lan

**官方网站：** [https://github.com/dsphper/lanhu-mcp](https://github.com/dsphper/lanhu-mcp)
...
资源文件：`resources/mcp/aiunite-lanhu.json`。内容最后核验于 `2026-08-30`；免费额度和服务限制可能随官方政策变化。
