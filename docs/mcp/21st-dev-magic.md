...
**Official site: ** [https://github.com/21st-dev/magic-mcp](https://github.com/21st-dev/magic-mcp)
...
Resource file: `resources/mcp/21st-dev-magic.json`. Content last verified on `2026-08-30`; free quotas and service limits may change with official policies.
