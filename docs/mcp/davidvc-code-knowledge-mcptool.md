...
**Official site: ** [https://github.com/davidvc/code-knowledge-mcptool](https://github.com/davidvc/code-knowledge-mcptool)
**Status: ** `active`　**Last verified: ** `2026-08-30`

## Categories & Tags

- Categories: `search`, `memory`
- Tags: `knowledge and memory`, `developer tools`, `search`, `chinese`
...
Resource file: `resources/mcp/davidvc-code-knowledge-mcptool.json`. Content last verified on `2026-08-30`; free quotas and service limits may change with official policies.
