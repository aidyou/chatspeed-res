---
title: "实时股票分析 MCP 服务"
description: "实时股票分析 MCP 服务 --- 这是一个实时股票数据服务的MCP服务器。它通过东方财富网和雪球网获取金融数据，并将这些数据以工具的形式暴露给支持MCP的Agent。 代码仓库： https://github.com/DannyWongIsAvailable/real-time-stock-mcp-service.git - 免费免登录获取数据 功能特性 - 📊 查找股票 - 📈 K线数据查询（支持B股，H股，大盘，分时图） - 📉 技术指标分析 （MA，MACD，BOLL，RSI等等） - 💰 基本面数据分析（"
---

# 实时股票分析 MCP 服务

实时股票分析 MCP 服务 --- 这是一个实时股票数据服务的MCP服务器。它通过东方财富网和雪球网获取金融数据，并将这些数据以工具的形式暴露给支持MCP的Agent。 代码仓库： https://github.com/DannyWongIsAvailable/real-time-stock-mcp-service.git - 免费免登录获取数据 功能特性 - 📊 查找股票 - 📈 K线数据查询（支持B股，H股，大盘，分时图） - 📉 技术指标分析 （MA，MACD，BOLL，RSI等等） - 💰 基本面数据分析（
