---
title: "Hugging Face MCP 服务器"
description: "Hugging Face Official MCP Server Welcome to the official Hugging Face MCP Server 🤗. Connect your LLM to the Hugging Face Hub and thousands of Gradio AI Applications. Installing the MCP Server Follow the instructions belo"
---

# Hugging Face MCP 服务器

Hugging Face Official MCP Server Welcome to the official Hugging Face MCP Server 🤗. Connect your LLM to the Hugging Face Hub and thousands of Gradio AI Applications. Installing the MCP Server Follow the instructions belo
...
**官方网站：** [https://github.com/huggingface/hf-mcp-server](https://github.com/huggingface/hf-mcp-server)
**状态：** `active`　**最后核验：** `2026-08-30`

## 分类与标签

- 分类：`development`, `data`
- 标签：`developer tools`, `hugging face`, `machine learning`, `models`, `official`
...
资源文件：`resources/mcp/huggingface-hf-mcp.json`。内容最后核验于 `2026-08-30`；免费额度和服务限制可能随官方政策变化。
