...
description: "Hugging Face Official MCP Server Welcome to the official Hugging Face MCP Server 🤗. Connect your LLM to the Hugging Face Hub and thousands of Gradio AI Applications. Installing the MCP Server Follow t…"
---

# Hugging Face MCP Server

Hugging Face Official MCP Server Welcome to the official Hugging Face MCP Server 🤗. Connect your LLM to the Hugging Face Hub and thousands of Gradio AI Applications. Installing the MCP Server Follow t…
...
Enter the command below to install in 
Claude Code
:
...
Click 
here
 to add the Hugging Face connector directly to VSCode. Alternatively, install from the gallery at [https://code.visualstudio.com/mcp](https://code.visualstudio.com/mcp): 
...
Click 
here
 to install the Hugging Face MCP Server directly in 
Cursor
. 
...
in the separate [`hf-mcp-optimise`](https://github.com/huggingface/hf-mcp-server/blob/HEAD/docs/benchmarking.md) workspace.
...
```bash
hf spaces secrets add / -s METRICS_PAGE_PASSWORD=''
```
...
**Official site: ** [https://github.com/huggingface/hf-mcp-server](https://github.com/huggingface/hf-mcp-server)
**Status: ** `active`　**Last verified: ** `2026-08-30`

## Categories & Tags

- Categories: `development`, `data`
- Tags: `developer tools`, `hugging face`, `machine learning`, `models`, `official`
...
Resource file: `resources/mcp/huggingface-hf-mcp.json`. Content last verified on `2026-08-30`; free quotas and service limits may change with official policies.
