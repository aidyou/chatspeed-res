...
description: "Codacy MCP Server MCP Server for the Codacy API, enabling access to repositories, files, quality, coverage, security and more. Table of Contents - Features / Tools - Repository Setup and Management -…"
---

# Codacy MCP Server

Codacy MCP Server MCP Server for the Codacy API, enabling access to repositories, files, quality, coverage, security and more. Table of Contents - Features / Tools - Repository Setup and Management -…
...
**Official site: ** [https://github.com/codacy/codacy-mcp-server](https://github.com/codacy/codacy-mcp-server)
**Status: ** `active`　**Last verified: ** `2026-08-30`

## Categories & Tags

- Categories: `development`
- Tags: `developer tools`, `code quality`, `codacy`, `code review`, `official`
...
Resource file: `resources/mcp/codacy-mcp-server.json`. Content last verified on `2026-08-30`; free quotas and service limits may change with official policies.
