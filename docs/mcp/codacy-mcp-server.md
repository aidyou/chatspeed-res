---
title: "Codacy MCP 服务器"
description: "Codacy MCP Server MCP Server for the Codacy API, enabling access to repositories, files, quality, coverage, security and more. Table of Contents - Features / Tools - Repository Setup and Management - Organization and Rep"
---

# Codacy MCP 服务器

Codacy MCP Server MCP Server for the Codacy API, enabling access to repositories, files, quality, coverage, security and more. Table of Contents - Features / Tools - Repository Setup and Management - Organization and Rep
...
![Copilot Agent with Codacy tools](https://github.com/codacy/codacy-mcp-server/blob/HEAD/docs/copilot_agent.png)
...
**官方网站：** [https://github.com/codacy/codacy-mcp-server](https://github.com/codacy/codacy-mcp-server)
**状态：** `active`　**最后核验：** `2026-08-30`

## 分类与标签

- 分类：`development`
- 标签：`developer tools`, `code quality`, `codacy`, `code review`, `official`

## MCP 配置

- 传输方式：`stdio`
- 启动命令：`npx`
- 参数：`-y @codacy/mcp-server`

该配置可通过资源站点索引导入 ChatSpeed。导入前请确认命令、参数和权限来源可信。

## 数据来源

资源文件：`resources/mcp/codacy-mcp-server.json`。内容最后核验于 `2026-08-30`；免费额度和服务限制可能随官方政策变化。
