---
title: "小红书MCP"
description: "一个用于自动化操作小红书的工具，包括登录、发布内容、搜索和获取推荐。支持Model Context Protocol (MCP)，可以与多种AI客户端集成。"
---

# 小红书MCP

一个用于自动化操作小红书的工具，包括登录、发布内容、搜索和获取推荐。支持Model Context Protocol (MCP)，可以与多种AI客户端集成。
...
**发布结果：**
 ...
 alt="xiaohongshu-mcp 发布结果" width="400">

**官方网站：** [https://github.com/xpzouying/xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp)
...
资源文件：`resources/mcp/zhaofengshun0723-xiaohongshu.json`。内容最后核验于 `2026-08-30`；免费额度和服务限制可能随官方政策变化。
