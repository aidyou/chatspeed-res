...
description: "小红书mcp服务， 1. 支持自动发布 2. 支持搜索笔记 3. 支持分析笔记内容 4. 支持多账户管理 5. 支持预发布（人工审核后发布） 6. 支持评论特定笔记引流，支持@指定人 支持mcp，api调用"
---

# 小红书一站式自动化MCP（10月17可用）

小红书mcp服务， 1. 支持自动发布 2. 支持搜索笔记 3. 支持分析笔记内容 4. 支持多账户管理 5. 支持预发布（人工审核后发布） 6. 支持评论特定笔记引流，支持@指定人 支持mcp，api调用
