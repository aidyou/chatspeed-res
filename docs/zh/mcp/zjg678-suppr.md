...
description: "Suppr MCP - Usage Guide 提供文档翻译及中文搜Pubmed的MCP服务 Suppr超能文献 Quick Start 1. 安装 全局安装： bash npm install -g suppr-mcp 或者使用 npx（无需安装）： bash npx suppr-mcp 2. 获取 API Key 访问 Suppr API 获取您的 API 密钥。 3. 配置环境变量 bash…"
---

# 超能文献-文档翻译&中文搜pubmed

Suppr MCP - Usage Guide 提供文档翻译及中文搜Pubmed的MCP服务 Suppr超能文献 Quick Start 1. 安装 全局安装： bash npm install -g suppr-mcp 或者使用 npx（无需安装）： bash npx suppr-mcp 2. 获取 API Key 访问 Suppr API 获取您的 API 密钥。 3. 配置环境变量 bash…
