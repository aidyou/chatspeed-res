---
title: "智能专家辩论系统MCP"
description: "基于本地MCP（Model Context Protocol）的AI专家辩论系统，采用动态专家生成架构，根据问题而智能的创建最适合的专家组合进行多轮智慧碰撞。 Multi-round AI expert debate system via MCP - Three thought leaders engage in deep discussions on any topic"
---

# 智能专家辩论系统MCP

基于本地MCP（Model Context Protocol）的AI专家辩论系统，采用动态专家生成架构，根据问题而智能的创建最适合的专家组合进行多轮智慧碰撞。 Multi-round AI expert debate system via MCP - Three thought leaders engage in deep discussions on any topic
