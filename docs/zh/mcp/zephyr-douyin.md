---
title: "抖音小助手（by 云中江树）"
description: "抖音运营助手，用于提取抖音无水印视频链接、视频文案、IP文案、素材文案以及文案对标改写等功能。 官方地址：https://github.com/yzfly/douyin-mcp-server"
---

# 抖音小助手（by 云中江树）

抖音运营助手，用于提取抖音无水印视频链接、视频文案、IP文案、素材文案以及文案对标改写等功能。 官方地址：https://github.com/yzfly/douyin-mcp-server
