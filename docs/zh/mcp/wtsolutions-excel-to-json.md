...
description: "Excel到JSON MCP（模型上下文协议）提供了一个标准化接口，用于通过模型上下文协议将Excel和CSV数据转换为JSON格式。此MCP实现提供了两个特定的数据转换工具： - exceltojsonmcpfromdata：将制表符分隔的Excel数据或逗号分隔的CSV文本数据转换为JSON格式。 - exceltojsonmcpfromurl：从提供的URL转换Excel文件（.xlsx）"
---

# Excel CSV 转JSON MCP by WTSolutions

Excel到JSON MCP（模型上下文协议）提供了一个标准化接口，用于通过模型上下文协议将Excel和CSV数据转换为JSON格式。此MCP实现提供了两个特定的数据转换工具： - exceltojsonmcpfromdata：将制表符分隔的Excel数据或逗号分隔的CSV文本数据转换为JSON格式。 - exceltojsonmcpfromurl：从提供的URL转换Excel文件（.xlsx）

# Excel to JSON MCP by WTSolutions

[中文](https://github.com/he-yang/excel-to-json-mcp/blob/HEAD/README-zh.md)
...
* Excel to JSON MCP Service: Convert Excel to JSON by AI Model MCP SSE/StreamableHTTP request. ( Note:
...
By using Excel to JSON MCP, you agree to the [service agreement](https://github.com/he-yang/excel-to-json-mcp/blob/HEAD/TERMS.md), and [privacy policy](https://github.com/he-yang/excel-to-json-mcp/blob/HEAD/PRIVACY.md).
