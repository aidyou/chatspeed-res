---
title: "论文搜索"
description: "论文搜索 MCP 一个用于从多个来源（包括 arXiv、PubMed、bioRxiv 和 Sci-Hub（可选））搜索和下载学术论文的模型上下文协议 (MCP) 服务器。设计用于与大型语言模型（如 Claude Desktop）无缝集成。"
---

# 论文搜索

论文搜索 MCP 一个用于从多个来源（包括 arXiv、PubMed、bioRxiv 和 Sci-Hub（可选））搜索和下载学术论文的模型上下文协议 (MCP) 服务器。设计用于与大型语言模型（如 Claude Desktop）无缝集成。
