...
description: "Crossref MCP 服务器 一个用于与 Crossref API 交互的 Model Context Protocol (MCP) 服务器。 功能 - 按标题搜索作品 - 按作者搜索作品 - 通过 DOI 获取作品详情 安装 { \"mcpServers\": { \"crossref\": { \"command\": \"npx\", \"args\": [ \"-y\", \"@botanicastudios/…"
---

# botanicastudios

Crossref MCP 服务器 一个用于与 Crossref API 交互的 Model Context Protocol (MCP) 服务器。 功能 - 按标题搜索作品 - 按作者搜索作品 - 通过 DOI 获取作品详情 安装 { "mcpServers": { "crossref": { "command": "npx", "args": [ "-y", "@botanicastudios/…
