...
description: "微信公众号 MCP 服务简介 服务概述 微信公众号MCP（模型控制协议）服务是一个专为通过AI自动化简化微信公众号管理而设计的专业工具。该服务为在微信公众号上创建、发布和管理内容提供了标准化接口，消除了常规发布任务中的手动干预需求。 核心功能 - 访问令牌管理：安全处理认证凭证 - 内容创建：支持文本、图片和HTML格式的富媒体内容草稿的程序化创建 - 发布自动化：定时或按需将内容发布到微信公众号…"
---

# 微信公众号API-MCP-Server

微信公众号 MCP 服务简介 服务概述 微信公众号MCP（模型控制协议）服务是一个专为通过AI自动化简化微信公众号管理而设计的专业工具。该服务为在微信公众号上创建、发布和管理内容提供了标准化接口，消除了常规发布任务中的手动干预需求。 核心功能 - 访问令牌管理：安全处理认证凭证 - 内容创建：支持文本、图片和HTML格式的富媒体内容草稿的程序化创建 - 发布自动化：定时或按需将内容发布到微信公众号…
