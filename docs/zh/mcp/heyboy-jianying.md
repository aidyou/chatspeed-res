---
title: "剪映mcp"
description: "JianYing MCP - 剪映视频制作 MCP 服务器 一个基于 Model Context Protocol (MCP) 的剪映视频制作自动化工具，让 AI 助手能够通过自然语言创建专业的视频内容。 🎯 项目简介 jianying mcp 是一个强大的视频制作自动化工具，通过 MCP 协议让 AI 能够： - 🎬 自动创建剪映草稿项目 - 🎵 智能添加音频、视频、文本素材 - ✨ 应用各种特…"
---

# 剪映mcp

JianYing MCP - 剪映视频制作 MCP 服务器 一个基于 Model Context Protocol (MCP) 的剪映视频制作自动化工具，让 AI 助手能够通过自然语言创建专业的视频内容。 🎯 项目简介 jianying mcp 是一个强大的视频制作自动化工具，通过 MCP 协议让 AI 能够： - 🎬 自动创建剪映草稿项目 - 🎵 智能添加音频、视频、文本素材 - ✨ 应用各种特…
