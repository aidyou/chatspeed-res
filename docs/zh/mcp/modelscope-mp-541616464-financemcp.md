---
title: "金融MCP"
description: "基于MCP协议的专业金融数据服务器，集成Tushare API，为Claude等AI助手提供实时金融数据和技术指标分析。 - - - - - - - - - 🎉 开箱即用，无需部署！ 我们提供多种免费公共云服务选项： 🚀 最简单的使用方式！ 访问我们的在线体验网站： - ✨ 零配置体验 - 无需任何设置，打开网页即用 - 🤖 集成大模型 - 直接与AI助手对话，获取金融分析 - 💬 智能交互 -…"
---

# 金融MCP

基于MCP协议的专业金融数据服务器，集成Tushare API，为Claude等AI助手提供实时金融数据和技术指标分析。 - - - - - - - - - 🎉 开箱即用，无需部署！ 我们提供多种免费公共云服务选项： 🚀 最简单的使用方式！ 访问我们的在线体验网站： - ✨ 零配置体验 - 无需任何设置，打开网页即用 - 🤖 集成大模型 - 直接与AI助手对话，获取金融分析 - 💬 智能交互 -…
...
本项目采用MIT许可证。详见[LICENSE](https://github.com/guangxiangdebizi/FinanceMCP/blob/HEAD/LICENSE)文件。
