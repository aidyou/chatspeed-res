---
title: "哔哩视频提取器"
description: "BiliBili MCP Processor 一个基于 Model Context Protocol (MCP) 的哔哩哔哩视频内容处理工具，可以加载、分析和导出B站视频的字幕和内容。 功能特性 - 🎥 视频内容加载: 使用LangChain加载器获取B站视频内容和字幕 - 🔍 内容搜索: 在视频内容中进行文本搜索，支持上下文显示 - 📝 智能摘要: 自动生成视频内容摘要 - 📤 多格式导出: 支…"
---

# 哔哩视频提取器

BiliBili MCP Processor 一个基于 Model Context Protocol (MCP) 的哔哩哔哩视频内容处理工具，可以加载、分析和导出B站视频的字幕和内容。 功能特性 - 🎥 视频内容加载: 使用LangChain加载器获取B站视频内容和字幕 - 🔍 内容搜索: 在视频内容中进行文本搜索，支持上下文显示 - 📝 智能摘要: 自动生成视频内容摘要 - 📤 多格式导出: 支…
