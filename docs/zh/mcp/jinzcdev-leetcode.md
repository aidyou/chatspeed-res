...
MCP 服务器实现 LeetCode API 集成，支持自动化获取编程题库、用户数据和竞赛信息。
...
**官方网站：** [https://github.com/jinzcdev/leetcode-mcp-server](https://github.com/jinzcdev/leetcode-mcp-server)
**状态：** `active`　**最后核验：** `2026-08-30`

## 分类与标签

- 分类：`development`, `memory`, `data`
- 标签：`research and data`, `knowledge and memory`, `developer tools`, `leetcode`, `编程`, `力扣`, `算法`, `数据结构`, `chinese`

## MCP 配置

- 传输方式：`stdio`
- 启动命令：`npx`
- 参数：`-y @jinzcdev/leetcode-mcp-server --site cn`

该配置可通过资源站点索引导入 ChatSpeed。导入前请确认命令、参数和权限来源可信。

## 数据来源

资源文件：`resources/mcp/jinzcdev-leetcode.json`。内容最后核验于 `2026-08-30`；免费额度和服务限制可能随官方政策变化。
