---
title: "飞猪旅行"
description: "✈️ 飞猪旅行 一站式旅行 MCP 服务，覆盖机票、酒店、火车票、景点、美食、市内交通、万豪酒店等 11 个工具，与飞猪官方 MCP schema 100% 兼容。 ✨ 核心特性 ▸ 官方兼容 — 飞猪工具参数名与官方 MCP 完全一致（camelCase），可无缝切换 endpoint ▸ 零配置接入 — 内置代理服务，无需申请 API Key，配置即用 ▸ 九重安全防护 — 限频、缓存、日限、…"
---

# 飞猪旅行

✈️ 飞猪旅行 一站式旅行 MCP 服务，覆盖机票、酒店、火车票、景点、美食、市内交通、万豪酒店等 11 个工具，与飞猪官方 MCP schema 100% 兼容。 ✨ 核心特性 ▸ 官方兼容 — 飞猪工具参数名与官方 MCP 完全一致（camelCase），可无缝切换 endpoint ▸ 零配置接入 — 内置代理服务，无需申请 API Key，配置即用 ▸ 九重安全防护 — 限频、缓存、日限、…
