---
title: "滴答清单MCP增强版"
description: "滴答清单 MCP 增强版 一个 Model Context Protocol (MCP) 服务器，允许大语言模型管理你的滴答清单/TickTick 待办事项。 🔗 API 文档: 滴答清单官方 OpenAPI --- 🛠️ 准备工作 - Python 3.10+ - 已安装 uv (推荐) - 滴答清单或 TickTick 账号 - API 凭证 (Client ID, Client Secret…"
---

# 滴答清单MCP增强版

滴答清单 MCP 增强版 一个 Model Context Protocol (MCP) 服务器，允许大语言模型管理你的滴答清单/TickTick 待办事项。 🔗 API 文档: 滴答清单官方 OpenAPI --- 🛠️ 准备工作 - Python 3.10+ - 已安装 uv (推荐) - 滴答清单或 TickTick 账号 - API 凭证 (Client ID, Client Secret…
