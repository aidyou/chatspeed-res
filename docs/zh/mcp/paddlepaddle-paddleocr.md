...
description: "PaddleOCR MCP服务器 概述 PaddleOCR MCP服务器为AI应用提供工业级OCR和文档解析能力。基于PaddleOCR——一个经过5万+GitHub star验证，被MinerU、RAGFlow、OmniParser等头部项目深度集成的成熟解决方案，并基于MCP理念做了针对性的优化。 官方文档：https://paddlepaddle.github.io/PaddleOCR/la…"
---

# PaddleOCR MCP 服务器

PaddleOCR MCP服务器 概述 PaddleOCR MCP服务器为AI应用提供工业级OCR和文档解析能力。基于PaddleOCR——一个经过5万+GitHub star验证，被MinerU、RAGFlow、OmniParser等头部项目深度集成的成熟解决方案，并基于MCP理念做了针对性的优化。 官方文档：https://paddlepaddle.github.io/PaddleOCR/la…
