---
title: "stata-mcp"
description: "Stata-MCP 让LLM帮助你使用Stata进行回归分析 ✨ --- 寻找其他Stata集成或其他工具？ - VScode或Cursor集成在这里。感到困惑？💡 差异 - Jupyter Lab使用（重要：Stata 17+）在这里 - NBER-MCP 🔧 正在建设中 - AER-MCP - Econometrics-Agent - TexIV - 一个由机器学习驱动的框架，使用先进的NLP…"
---

# stata-mcp

Stata-MCP 让LLM帮助你使用Stata进行回归分析 ✨ --- 寻找其他Stata集成或其他工具？ - VScode或Cursor集成在这里。感到困惑？💡 差异 - Jupyter Lab使用（重要：Stata 17+）在这里 - NBER-MCP 🔧 正在建设中 - AER-MCP - Econometrics-Agent - TexIV - 一个由机器学习驱动的框架，使用先进的NLP…
