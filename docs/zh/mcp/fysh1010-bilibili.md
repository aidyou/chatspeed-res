---
title: "B站视频解析下载"
description: "一个用于解析哔哩哔哩（Bilibili）视频的 Model Context Protocol (MCP) 服务器，支持视频信息提取、下载链接获取和合集解析等功能。"
---
...
**官方网站：** [https://github.com/fysh1010/bilibili-mcp](https://github.com/fysh1010/bilibili-mcp)
**状态：** `active`　**最后核验：** `2026-08-30`

## 分类与标签

- 分类：`media`
- 标签：`entertainment and media`, `视频`, `chinese`

## MCP 配置

- 传输方式：`stdio`
- 启动命令：`npx`
- 参数：`-y mcp-server-bilibili`

该配置可通过资源站点索引导入 ChatSpeed。导入前请确认命令、参数和权限来源可信。

## 数据来源

资源文件：`resources/mcp/fysh1010-bilibili.json`。内容最后核验于 `2026-08-30`；免费额度和服务限制可能随官方政策变化。
