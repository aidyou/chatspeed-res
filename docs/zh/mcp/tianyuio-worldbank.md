...
description: "世界银行MCP 🌐 基于世界银行开放数据API的世界银行模型上下文协议服务，提供全球经济发展数据的查询功能。 📋 功能 - ✅ 国家信息查询 - ✅ 指标搜索（教育、健康、环境等） - ✅ 经济数据查询（GDP、通货膨胀、失业率等） - ✅ 社会发展数据查询（人口、预期寿命、互联网使用情况等） - ✅ 教育数据查询（识字率、入学率等） - ✅ 健康与营养数据查询（医院、免疫接种、HIV感染率、营养…"
---

# World Bank MCP - 世界银行 MCP

世界银行MCP 🌐 基于世界银行开放数据API的世界银行模型上下文协议服务，提供全球经济发展数据的查询功能。 📋 功能 - ✅ 国家信息查询 - ✅ 指标搜索（教育、健康、环境等） - ✅ 经济数据查询（GDP、通货膨胀、失业率等） - ✅ 社会发展数据查询（人口、预期寿命、互联网使用情况等） - ✅ 教育数据查询（识字率、入学率等） - ✅ 健康与营养数据查询（医院、免疫接种、HIV感染率、营养…
