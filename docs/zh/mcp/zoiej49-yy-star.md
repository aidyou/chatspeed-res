---
title: "星座mcp"
description: "星座 MCP 服务 (Star MCP) 一个功能完整的星座 MCP (Model Context Protocol) 服务，提供星座信息查询、运势分析、配对测试等功能。 功能特性 🌟 核心功能 - 星座信息查询: 获取12星座的详细信息，包括性格特征、守护星、元素等 - 今日运势: 提供爱情、事业、健康、财运、综合运势查询 - 星座配对: 分析两个星座的配对指数和关系 - 生日星座: 根据出生日…"
---

# 星座mcp

星座 MCP 服务 (Star MCP) 一个功能完整的星座 MCP (Model Context Protocol) 服务，提供星座信息查询、运势分析、配对测试等功能。 功能特性 🌟 核心功能 - 星座信息查询: 获取12星座的详细信息，包括性格特征、守护星、元素等 - 今日运势: 提供爱情、事业、健康、财运、综合运势查询 - 星座配对: 分析两个星座的配对指数和关系 - 生日星座: 根据出生日…
