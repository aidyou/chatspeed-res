...
description: "一个面向研究生论文级别文献综述的学术论文管理与分析工具。支持Model Context Protocol (MCP)标准，提供多源学术搜索、智能压缩、批量分析、跨文献综述生成等功能。"
---

# literature-review-mcp

一个面向研究生论文级别文献综述的学术论文管理与分析工具。支持Model Context Protocol (MCP)标准，提供多源学术搜索、智能压缩、批量分析、跨文献综述生成等功能。
...
完整更新日志见 [CHANGELOG.md](https://github.com/ydzat/literature-review-mcp/blob/HEAD/CHANGELOG.md)

## 许可证

MIT License - 详见 [LICENSE](https://github.com/ydzat/literature-review-mcp/blob/HEAD/LICENSE) 文件
...
**官方网站：** [https://github.com/ydzat/literature-review-mcp](https://github.com/ydzat/literature-review-mcp)
...
- 传输方式：`stdio`
- 启动命令：`npx`
- 参数：`-y @ydzat/literature-review-mcp@latest`

该配置可通过资源站点索引导入 ChatSpeed。导入前请确认命令、参数和权限来源可信。

## 数据来源

资源文件：`resources/mcp/oafoak-literature-review.json`。内容最后核验于 `2026-08-30`；免费额度和服务限制可能随官方政策变化。
