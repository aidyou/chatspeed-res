...
description: "📈 AkTools MCP Server 基于 akshare 的 MCP (Model Context Protocol) 服务器，提供股票、虚拟货币的数据查询和分析功能。 功能 - 股票搜索: 根据公司名称、股票名称等关键词查找股票代码 - 股票信息: 获取股票的详细信息，包括价格、市值等 - 历史价格: 获取股票、虚拟货币历史价格数据，包含技术分析指标 - 相关新闻: 获取股票、虚拟货币相关…"
---

# AkTools MCP 分析股票、虚拟货币

📈 AkTools MCP Server 基于 akshare 的 MCP (Model Context Protocol) 服务器，提供股票、虚拟货币的数据查询和分析功能。 功能 - 股票搜索: 根据公司名称、股票名称等关键词查找股票代码 - 股票信息: 获取股票的详细信息，包括价格、市值等 - 历史价格: 获取股票、虚拟货币历史价格数据，包含技术分析指标 - 相关新闻: 获取股票、虚拟货币相关…
