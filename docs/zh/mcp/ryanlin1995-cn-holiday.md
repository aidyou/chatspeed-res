---
title: "中国节日"
description: "中国节假日查询 MCP 服务 这是一个基于 MCP (Message Control Protocol) 的中国节假日查询服务，提供节假日和工作日的查询功能。数据来源于 holiday-cn 项目。"
---

# 中国节日

中国节假日查询 MCP 服务 这是一个基于 MCP (Message Control Protocol) 的中国节假日查询服务，提供节假日和工作日的查询功能。数据来源于 holiday-cn 项目。
