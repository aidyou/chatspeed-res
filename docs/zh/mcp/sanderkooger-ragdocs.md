---
title: "MCP文档增强服务器"
description: "一种MCP服务器实现，它提供了通过向量搜索检索和处理文档的工具，使AI助手能够用相关的文档上下文来增强其响应。 使用Ollama或OpenAI生成嵌入式内容。 包含Docker文件。"
---

# MCP文档增强服务器

一种MCP服务器实现，它提供了通过向量搜索检索和处理文档的工具，使AI助手能够用相关的文档上下文来增强其响应。 使用Ollama或OpenAI生成嵌入式内容。 包含Docker文件。
